...
jpeg(filename = file.path("output/Colegios/Graficas/Resultado_covar_INSE/Modelo washMach/Fay.jpg"),width = 1200,height = 1200)
gridExtra::grid.arrange( G1,G0,G2, ncol=1)
dev.off()     

ggsave(G0,filename = "output/Colegios/Graficas/Resultado_covar_INSE/Modelo washMach/Fay.GREG.jpg",width=15, height=12)
ggsave(G1,filename = "output/Colegios/Graficas/Resultado_covar_INSE/Modelo washMach/Fay.HT.jpg",width=15, height=12)
ggsave(G2,filename = "output/Colegios/Graficas/Resultado_covar_INSE/Modelo washMach/Fay.COMP.jpg",width=15, height=12)
...
write.table(IE.RESULTADO,file = "output/Colegios/Promedios/Resultados.IE1.washMach.txt",sep="\t",quote = FALSE,row.names = FALSE)
